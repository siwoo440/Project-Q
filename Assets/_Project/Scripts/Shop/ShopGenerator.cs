...
{
    public sealed class ShopGenerator : MonoBehaviour // 카드·유물·회복·제거 상점 상품 후보 생성 클래스
    {
        ...
        public void Configure(List<CardData> cards, List<RelicData> relics, int seed, float recoveryAmount, int recoveryPrice, int removePrice) // 에디터 자동 구성용 상점 후보 설정 메서드
        {
